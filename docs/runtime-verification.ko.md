...
Windows x64와 Linux x64 backend는 macOS에서 cross-target Clippy를 통과했습니다. 이는 compile 근거이지 live permission/device/display 동작 근거가 아닙니다. release 전에 대상 장비 output을 기록하십시오.
